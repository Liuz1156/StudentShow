  ...
  <tr>
    ...
    <td width='80%' align="right" valign="bottom">
      ...
      <td align="right" height="26" style="padding-right:10px;line-height:26px;">
        	您好：<span class="username"><%=strUsername%></span>，欢迎使用网站管理系统！
        	
        	
        	[<a href="../index.aspx" target="_top">学生登录</a>]<asp:LinkButton ID="btnLoginOut" runat ="server" Text="注销退出" OnClick="btnLoginOut_Click"></asp:LinkButton>&nbsp;
      </td>
      </tr>
    </table></td>
  </tr>
